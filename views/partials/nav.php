      ...
      <div class="flex items-center">
        ...
        <div class="hidden md:block">
          <div class="ml-10 flex items-baseline space-x-4">
            ...
            <?php endif ?> <a href="/contact" class="<?php echo $val = urlIs('/contact') ? 'bg-gray-900 text-white' : "text-gray-300 hover:bg-gray-700 hover:text-white" ?> block rounded-md px-3 py-2 text-base font-medium">Contact</a>
          </div>
        </div>
      </div>
      <div class="hidden md:block">
        <div class="ml-4 flex items-center md:ml-6">
          ...
          <!-- Profile dropdown -->
          <?php if ($_SESSION['user'] ?? false) : ?>
            <div class="relative ml-3 flex flex-row items-center justify-space gap-x-2">
              <div>
